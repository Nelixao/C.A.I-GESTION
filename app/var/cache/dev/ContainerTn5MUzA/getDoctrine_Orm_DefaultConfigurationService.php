...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\CircularRepository' => ['privates', 'App\\Repository\\CircularRepository', 'getCircularRepositoryService', true],
            'App\\Repository\\CisaeRepository' => ['privates', 'App\\Repository\\CisaeRepository', 'getCisaeRepositoryService', true],
            'App\\Repository\\CorrespondenceRepository' => ['privates', 'App\\Repository\\CorrespondenceRepository', 'getCorrespondenceRepositoryService', true],
            'App\\Repository\\DocumentoTipoRepository' => ['privates', 'App\\Repository\\DocumentoTipoRepository', 'getDocumentoTipoRepositoryService', true],
            'App\\Repository\\NotaInformativaRepository' => ['privates', 'App\\Repository\\NotaInformativaRepository', 'getNotaInformativaRepositoryService', true],
            'App\\Repository\\OficioRepository' => ['privates', 'App\\Repository\\OficioRepository', 'getOficioRepositoryService', true],
            'App\\Repository\\RoleRepository' => ['privates', 'App\\Repository\\RoleRepository', 'getRoleRepositoryService', true],
            'App\\Repository\\ScannerRepository' => ['privates', 'App\\Repository\\ScannerRepository', 'getScannerRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\CircularRepository' => '?',
            'App\\Repository\\CisaeRepository' => '?',
            'App\\Repository\\CorrespondenceRepository' => '?',
            'App\\Repository\\DocumentoTipoRepository' => '?',
            'App\\Repository\\NotaInformativaRepository' => '?',
            'App\\Repository\\OficioRepository' => '?',
